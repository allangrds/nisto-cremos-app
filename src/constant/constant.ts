...
export const creeds: Creed[] = [
  {
    ...
    tags: ['bíblia', 'sagrada', 'escrituras', 'sagradas', '1'],
    numbering: 1,
  },
  {
    title: 'A trindade',
    ...
    tags: ['trindade', 'deus', 'jesus', 'espírito santo', '2'],
    numbering: 2,
  },
  {
    title: 'Deus pai',
    ...
    biblical_passages: [
      ...
      },
      {
        label: 'Sl 110:1,4',
        passage:
          'Disse o SENHOR ao meu Senhor: Assenta-te à minha mão direita, até que ponha os teus inimigos por escabelo dos teus pés. Jurou o Senhor, e não se arrependerá: tu és um sacerdote eterno, segundo a ordem de Melquisedeque.',
      },
      {
        label: 'Jo 3:16',
        passage:
  ...
  },
  {
    ...
    tags: ['deus', 'filho', 'jesus', 'salvador', '4'],
    numbering: 4,
  },
  {
    ...
    tags: ['espírito', 'espírito santo', 'consolador', '5'],
    numbering: 5,
  },
  {
    title: 'A Criação',
    ...
    biblical_passages: [
      ...
      },
      {
        label: 'Sl 33:6,9',
        passage:
          'Pela palavra do Senhor foram feitos os céus, e todo o exército deles pelo espírito da sua boca.[...]Porque falou, e foi feito; mandou, e logo apareceu.',
      },
      {
        label: 'Sl 104',
        passage:
    ...
    //;
    tags: ['criação', 'gênesis', 'genesis', '6'],
    numbering: 6,
  },
  {
    ...
    biblical_passages: [
      ...
      },
      {
        label: 'Gn 2:7,15',
        passage:
          'E formou o Senhor Deus o homem do pó da terra, e soprou em suas narinas o fôlego da vida; e o homem foi feito alma vivente. E tomou o Senhor Deus o homem, e o pôs no jardim do Éden para o lavrar e o guardar.',
      },
      {
        label: 'Gn 3',
        passage:
      ...
      },
      {
        label: 'Sl 51:5,10',
        passage:
          'Eis que em iniqüidade fui formado, e em pecado me concebeu minha mãe.[...]Cria em mim, ó Deus, um coração puro, e renova em mim um espírito reto.',
      },
      {
        label: 'Sl 58:3',
        passage:
      ...
      },
      {
        label: '2Co 5:19, 20',
        passage:
          'Isto é, Deus estava em Cristo reconciliando consigo o mundo, não lhes imputando os seus pecados; e pôs em nós a palavra da reconciliação. De sorte que somos embaixadores da parte de Cristo, como se Deus por nós rogasse. Rogamo-vos, pois, da parte de Cristo, que vos reconcilieis com Deus.',
      },
      {
        label: 'Ef 2:3',
        passage:
    ...
    tags: ['pecado', 'homem', 'morte', 'queda', '7'],
    numbering: 7,
  },
  {
  ...
  },
  {
    ...
    tags: ['jesus', 'cristo', 'jesus cristo', 'morte', 'ressureição', '9'],
    numbering: 9,
  },
  {
    ...
    biblical_passages: [
      ...
      },
      {
        label: 'Mc 9:23, 24',
        passage:
          'E Jesus disse-lhe: Se tu podes crer, tudo é possível ao que crê. E logo o pai do menino, clamando, com lágrimas, disse: Eu creio, Senhor! ajuda a minha incredulidade.  Marcos 9:24',
      },
      {
        label: 'Jo 3:3-8',
        passage:
      ...
      },
      {
        label: 'Gl 3:13,14,26',
        passage:
          'Cristo nos resgatou da maldição da lei, fazendo-se maldição por nós; porque está escrito: Maldito todo aquele que for pendurado no madeiro; Para que a bênção de Abraão chegasse aos gentios por Jesus Cristo, e para que pela fé nós recebamos a promessa do Espírito. Porque todos sois filhos de Deus pela fé em Cristo Jesus.',
      },
      {
        label: 'Gl 4:4-7',
        passage:
  ...
  },
  {
    ...
    biblical_passages: [
      ...
      },
      {
        label: 'Cl 2:6,14,15',
        passage:
          'Como, pois, recebestes o Senhor Jesus Cristo, assim também andai nele, Havendo riscado a cédula que era contra nós nas suas ordenanças, a qual de alguma maneira nos era contrária, e a tirou do meio de nós, cravando-a na cruz. E, despojando os principados e potestades, os expôs publicamente e deles triunfou em si mesmo.',
      },
      {
        label: '1Ts 5:16-18, 23',
        passage:
          'Regozijai-vos sempre. Orai sem cessar. Em tudo dai graças, porque esta é a vontade de Deus em Cristo Jesus para convosco.[...] E o mesmo Deus de paz vos santifique em tudo; e todo o vosso espírito, e alma, e corpo, sejam plenamente conservados irrepreensíveis para a vinda de nosso Senhor Jesus Cristo.',
      },
      {
        label: 'Hb 10:25',
        passage:
    ...
    tags: ['jesus', 'cristo', 'crescimento', 'vida', 'espiritual', '11'],
    numbering: 11,
  },
  {
    title: 'A igreja',
  ...
  },
  {
    ...
    biblical_passages: [
      ...
      },
      {
        label: 'Cl 3:10-15',
        passage:
          'E vos vestistes do novo, que se renova para o conhecimento, segundo a imagem daquele que o criou; Onde não há grego, nem judeu, circuncisão, nem incircuncisão, bárbaro, cita, servo ou livre; mas Cristo é tudo, e em todos. Revesti-vos, pois, como eleitos de Deus, santos e amados, de entranhas de misericórdia, de benignidade, humildade, mansidão, longanimidade; Suportando-vos uns aos outros, e perdoando-vos uns aos outros, se alguém tiver queixa contra outro; assim como Cristo vos perdoou, assim fazei vós também. E, sobre tudo isto, revesti-vos de amor, que é o vínculo da perfeição. E a paz de Deus, para a qual também fostes chamados em um corpo, domine em vossos corações; e sede agradecidos.',
      },
    ],
    tags: ['jesus', 'cristo', 'unidade', 'corpo', '14'],
    numbering: 14,
  },
  {
    title: 'O Batismo',
    ...
    biblical_passages: [
      ...
      },
      {
        label: 'Cl 2:12, 13',
        passage:
          'Sepultados com ele no batismo, nele também ressuscitastes pela fé no poder de Deus, que o ressuscitou dentre os mortos. E, quando vós estáveis mortos nos pecados, e na incircuncisão da vossa carne, vos vivificou juntamente com ele, perdoando-vos todas as ofensas,',
      },
    ],
    tags: ['batismo', '15'],
    numbering: 15,
  },
  {
    ...
    tags: ['jesus', 'sangue', 'corpo', 'santa', 'ceia', '16'],
    numbering: 16,
  },
  {
    ...
    tags: ['dons', 'ministérios', 'espirituais', '17'],
    numbering: 17,
  },
  {
  ...
  },
  {
    ...
    tags: ['sábado', 'criação', 'descanso', 'mandamento', '20'],
    numbering: 20,
  },
  {
    title: 'Mordomia',
    ...
    tags: ['mordomia', 'dízimo', 'oferta', 'tempo', 'recursos', '21'],
    numbering: 21,
  },
  {
  ...
  },
  {
    ...
    biblical_passages: [
      ...
      },
      {
        label: '1Co 7:7, 10, 11',
        passage:
          'Porque quereria que todos os homens fossem como eu mesmo; mas cada um tem de Deus o seu próprio dom, um de uma maneira e outro de outra. Todavia, aos casados mando, não eu mas o Senhor, que a mulher não se aparte do marido. Se, porém, se apartar, que fique sem casar, ou que se reconcilie com o marido; e que o marido não deixe a mulher.',
      },
      {
        label: '2Co 6:14',
        passage:
    ...
    tags: ['casamento', 'matrimônio', 'família', '23'],
    numbering: 23,
  },
  {
    ...
    tags: ['jesus', 'cristo', 'sacerdote', 'santuário', 'celestial'],
    numbering: 24,
  },
  {
    ...
    biblical_passages: [
      ...
      },
      {
        label: 'Jo 14:1-3',
        passage:
          'O homem, nascido da mulher, é de poucos dias e farto de inquietação. Sai como a flor, e murcha; foge também como a sombra, e não permanece. E sobre este tal abres os teus olhos, e a mim me fazes entrar no juízo contigo.',
      },
      {
        label: 'At 1:9-11',
        passage:
  ...
  },
  {
    ...
    biblical_passages: [
      ...
      },
      {
        label: 'Dn 12:2, 13',
        passage:
          'E muitos dos que dormem no pó da terra ressuscitarão, uns para vida eterna, e outros para vergonha e desprezo eterno. Tu, porém, vai até ao fim; porque descansarás, e te levantarás na tua herança, no fim dos dias.',
      },
      {
        label: 'Is 25:8',
        passage:
    ...
    tags: ['morte', 'pecado', 'ressurreição', '26'],
    numbering: 26,
  },
  {
